...
df_cosine_similarity_mason.head(4)
...
for i in msdl.SoftwareSolution.instances(): print(i)
...
for epoch in range(num_epochs):
    ...
    print(f'Epoch {epoch+1} - Training Loss: {running_loss/len(X_train)}')

with torch.no_grad():
    outputs = model_mlp(X_test.float())
